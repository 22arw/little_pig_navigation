...
abort_btn_num = 0
abort_btn_sym = ""
sim_enabled = False #changed from false
...
def getParameter():
    ...
    collect_btn_num = rospy.get_param("/basic_laser_pig/simulation/collect_button_num")
    collect_btn_sym = rospy.get_param("/basic_laser_pig/simulation/collect_button_sym")
    send_btn_num = rospy.get_param("/basic_laser_pig/simulation/send_button_num")
    send_btn_sym = rospy.get_param("/basic_laser_pig/simulation/send_button_sym")
    calibrate_btn_num = rospy.get_param("/basic_laser_pig/simulation/calibrate_button_num")
    calibrate_btn_sym = rospy.get_param("/basic_laser_pig/simulation/calibrate_button_sym")
    abort_btn_num = rospy.get_param("/basic_laser_pig/simulation/abort_button_num")
    abort_btn_sym = rospy.get_param("/basic_laser_pig/simulation/abort_button_sym")
    continue_btn_num = rospy.get_param("/basic_laser_pig/simulation/continue_button_num")
    continue_btn_sym = rospy.get_param("/basic_laser_pig/simulation/continue_button_sym")
    
    sim_enabled = rospy.get_param("/basic_laser_pig/simulation/sim_enabled")
...
def getPaths():
    ...
    if sim_enabled == True:
        location_collect = rospack.get_path('little_pig_navigation') + "/launch/include/collect_goals_sim.launch"
        location_send = rospack.get_path('little_pig_navigation') + "/launch/include/send_goals_sim.launch"
        location_calibrate = rospack.get_path('little_pig_navigation') + "/launch/include/heading_calibration_sim.launch"
        location_safety_node = rospack.get_path('little_pig_navigation') + "/launch/include/safety_node.launch"

    elif sim_enabled == False:
        location_collect = rospack.get_path('little_pig_navigation') + "/launch/include/collect_goals.launch"
        location_send = rospack.get_path('little_pig_navigation') + "/launch/include/send_goals.launch"
        location_calibrate = rospack.get_path('little_pig_navigation') + "/launch/include/heading_calibration.launch"
        location_safety_node = rospack.get_path('little_pig_navigation') + "/launch/include/safety_node.launch"
...
def launch_subscribers():
    ...
    rospy.Subscriber("/basic_laser_pig/simulation/joy",Joy, joy_CB )
    rospy.Subscriber("/basic_laser_pig/simulation/calibrate_status",Bool, calibrate_status_CB )
    rospy.Subscriber("/basic_laser_pig/simulation/collection_status",Bool, collection_status_CB )
    rospy.Subscriber("/basic_laser_pig/simulation/waypoint_following_status",Bool, waypoint_following_status_CB )
