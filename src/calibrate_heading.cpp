...
void getParams()
{
    ros::param::get("/basic_laser_pig/simulation/x_vel", x_vel);
    ros::param::get("/basic_laser_pig/simulation/x_vel_time", x_vel_time);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/frequency", frequency);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/delay", delay);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/magnetic_declination_radians", magnetic_declination_radians);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/yaw_offset", yaw_offset);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/zero_altitude", zero_altitude);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/broadcast_utm_transform", broadcast_utm_transform);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/publish_filtered_gps", publish_filtered_gps);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/use_odometry_yaw", use_odometry_yaw);
    ros::param::get("/basic_laser_pig/simulation/navsat_transform/wait_for_datum", wait_for_datum);
}
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_odom = n.subscribe("/basic_laser_pig/simulation/odometry/filtered_map", 100, filtered_odom_CB);
    ros::Publisher pubVel = n.advertise<geometry_msgs::Twist>("/ackermann_controller/cmd_vel",100);
    ros::Publisher pubCalibrationNodeEnded = n.advertise<std_msgs::Bool>("/basic_laser_pig/simulation/calibrate_status",100);
    ...
    //write params file
    std::string path =  ros::package::getPath("little_pig_navigation") + "/params/navsat_params.yaml";
