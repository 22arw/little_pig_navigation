...
{
    path_abs = ros::package::getPath("basic_laser_pig") + path_local;
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pubWaypointNodeEnded = n.advertise<std_msgs::Bool>("/basic_laser_pig/waypoint_following_status", 1000);
    ...
    ros::Subscriber sub_odom = n.subscribe("/basic_laser_pig/odometry/filtered_map", 1000, odometry_CB);
    ...
    ros::param::get("/basic_laser_pig/goalTolerance", goal_tolerance);
    ...
    ros::param::get("/basic_laser_pig/coordinates_file", path_local);
