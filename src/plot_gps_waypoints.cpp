...
int main(int argc, char** argv)
{
    ...
    // Get params
		ros::param::get("/basic_laser_pig/simulation/collect_button_num", collect_button_num);
		ros::param::get("/basic_laser_pig/simulation/end_button_num", end_button_num);
    	ros::param::get("/basic_laser_pig/simulation/filtered_coordinates_file", path_local_filtered);
    	ros::param::get("/basic_laser_pig/simulation/raw_coordinates_file", path_local_raw);
		ros::param::get("/basic_laser_pig/simulation/collect_button_sym", collect_button_sym);
		ros::param::get("/basic_laser_pig/simulation/end_button_sym", end_button_sym);
		ros::param::get("/basic_laser_pig/simulation/num_points", numPoints);
		ros::param::get("/basic_laser_pig/simulation/collection_time", collection_time);
    ...
    // Initialize time and set rates
     ...
     //Subscribe to topics
        ...
        ros::Subscriber sub_gps_filtered = n.subscribe("/basic_laser_pig/simulation/gps/filtered", 100, filtered_gps_CB);
		ros::Subscriber sub_joy = n.subscribe("/basic_laser_pig/simulation/joy", 100, joy_CB);


   //Read file path and create/open file
		std::string path_abs_raw =  ros::package::getPath("basic_laser_pig/simulation") + path_local_raw;	
        std::string path_abs_filtered =  ros::package::getPath("basic_laser_pig/simulation") + path_local_filtered;
