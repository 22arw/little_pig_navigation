...
int main(int argc, char** argv)
{
    ...
    pubVel = n.advertise<geometry_msgs::Twist>("ackermann_controller/cmd_vel_safe", 100);

    //Initiate subscriber
    ros::Subscriber sub_cmd_vel = n.subscribe("/basic_laser_pig/simulation/ackermann_controller/cmd_vel", 100, cmd_vel_CB);
